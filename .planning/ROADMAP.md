...
Plans:
- [ ] 11-01-PLAN.md — Apply flow fix: filled increment moved to accept, pending-aware UI, server-side guards (BUG-W01, W02, W03)
- [ ] 11-02-PLAN.md — My page status filters, checked_in STATUS_CONFIG, getCurrentWorker real aggregation (BUG-W04, W05, W06, W08)
- [ ] 11-03-PLAN.md — Net earnings display, dead route cleanup, auth bootstrap fix (BUG-W07, W09, W10, W12)
- [ ] 11-04-PLAN.md — Search/explore server-side filtering via searchParams (BUG-W11)
